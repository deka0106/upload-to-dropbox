...
const globby_1 = __nccwpck_require__(8850);
const core = __importStar(__nccwpck_require__(7733));
const fs = __importStar(__nccwpck_require__(7147));
const path_1 = __nccwpck_require__(1017);
const upload_1 = __nccwpck_require__(6384);
const utils_1 = __nccwpck_require__(6548);
const dropbox_1 = __nccwpck_require__(8387);
...
const dropbox_1 = __nccwpck_require__(8387);
const node_fetch_1 = __importDefault(__nccwpck_require__(8679));
...
var _dropbox = __nccwpck_require__(5785);
...
var _auth = __nccwpck_require__(667);
...
var _response = __nccwpck_require__(8613);
...
var _error = __nccwpck_require__(1992);
...
var _utils = __nccwpck_require__(1114);
...
var DropboxAuth = /*#__PURE__*/function () {
  function DropboxAuth(options) {
    ...
    if ((0, _utils.isBrowserEnv)()) {
      ...
      fetch = __nccwpck_require__(2941); // eslint-disable-line global-require
...
var _constants = __nccwpck_require__(6185);

var _routes = __nccwpck_require__(9759);
...
var iconvLite = __nccwpck_require__(4300);
...
var Buffer = (__nccwpck_require__(7865).Buffer);
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(5306) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(5928) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(6076) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return (__nccwpck_require__(6076).concat)(__nccwpck_require__(4159)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return (__nccwpck_require__(6076).concat)(__nccwpck_require__(4159)) },
        gb18030: function() { return __nccwpck_require__(9478) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(6611) },
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(3343) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return (__nccwpck_require__(3343).concat)(__nccwpck_require__(8767)) },
        encodeSkipVals: [
...
var bomHandling = __nccwpck_require__(2532),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __nccwpck_require__(4573); // Lazy load all encoding definitions.
...
iconv.enableStreamingAPI = function enableStreamingAPI(stream_module) {
    ...
    var streams = __nccwpck_require__(155)(stream_module);
...
let convert;
try {
	convert = (__nccwpck_require__(6751)/* .convert */ .O);
} catch (e) {}
...
var out = __nccwpck_require__(1253);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/globby@13.1.4/node_modules/globby/utilities.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/globby@13.1.4/node_modules/globby/ignore.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/globby@13.1.4/node_modules/globby/index.js
